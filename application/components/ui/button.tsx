    ...
    " hover:cursor-pointer text-primary",
    {
        variants: {
            variant: {
                ...
                delete: "font-semibold text-red-500 hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50 rounded-xl ",
            },
            size: {
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                blur && variant !== "ghost" ? "bg-stone-800/10 backdrop-blur-md" : "bg-black",
