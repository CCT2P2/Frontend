...
export function OldLoginForm() {
  ...
  return (
    <form
      action={dispatch}
      className={
        "w-96 mx-auto align-middle border-2 border-purple-400 rounded-3xl p-10 pt-4 relative bg-black group focus-within:something"
      }
    >
      <div
        className={
          "absolute bg-secondary/30 w-[103%] h-[103%] -left-2 -top-2 -z-50 blur-md rounded-xl"
        }
      ></div>
      <div className={"flex justify-center mb-4"}>
        <Image
      ...
      <div className={"flex flex-col justify-center gap-8 mt-10"}>
        <button className="px-4 py-2 bg-black border-2 text-purple-300 rounded-2xl border-purple-300 hover:text-black hover:bg-purple-300 transition-all duration-200">
          Log in
        </button>
        <div className="text-center text-sm">
          Don&apos;t have an account?{" "}
